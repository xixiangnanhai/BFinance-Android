...
public class BitcoinActivityManager {

    private final String TAG = BitcoinActivityManager.class.getSimpleName();
    private Stack<Activity> mActivityStack;
    private static BitcoinActivityManager mActivityManager;

    private BitcoinActivityManager() {
     ...
     * 单一实例
     */
    public static BitcoinActivityManager getInstance() {
        if (mActivityManager == null) {
            mActivityManager = new BitcoinActivityManager();
        }
