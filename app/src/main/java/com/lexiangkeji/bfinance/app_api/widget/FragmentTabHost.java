...
public class FragmentTabHost extends TabHost
    ...
    public void setCurrentTab(int index) {
        if (mOnTabPreChangeListener != null && mOnTabPreChangeListener.onTabPreChange(index)) {
            return;
        }
    ...
    public void setOnTabPreChangeListener(OnTabPreChangeListener l) {
        mOnTabPreChangeListener = l;
    }

    public interface OnTabPreChangeListener {
        boolean onTabPreChange(int index);
    }
}
